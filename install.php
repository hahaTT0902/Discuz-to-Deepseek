...
{
    $vars = array(
        array('displayorder' => 1, 'title' => '启用自动回帖', 'description' => '开启后使用 DeepSeek 自动生成回帖。', 'variable' => 'openai', 'type' => 'select', 'value' => '0', 'extra' => "1=是\n0=否"),
        ...
        array('displayorder' => 9, 'title' => '回复最新楼层', 'description' => '开启后回复最新可见楼层；关闭时只处理首帖。', 'variable' => 'openautoreply', 'type' => 'select', 'value' => '0', 'extra' => "1=是\n0=否"),
        array('displayorder' => 10, 'title' => '引用来源内容', 'description' => '在 AI 回复前添加引用块。', 'variable' => 'openquote', 'type' => 'select', 'value' => '0', 'extra' => "1=是\n0=否"),
        array('displayorder' => 11, 'title' => '有附件时跳过', 'description' => '帖子或来源楼层带附件时不自动回帖。', 'variable' => 'openattach', 'type' => 'select', 'value' => '0', 'extra' => "1=是\n0=否"),
        array('displayorder' => 12, 'title' => '记录调试日志', 'description' => '把 DeepSeek 返回内容和错误写入插件日志。', 'variable' => 'opendebug', 'type' => 'select', 'value' => '1', 'extra' => "1=是\n0=否"),
        array('displayorder' => 13, 'title' => '页面加载后触发', 'description' => '等待页面 load 事件后再插入触发脚本。', 'variable' => 'openonload', 'type' => 'select', 'value' => '1', 'extra' => "1=是\n0=否"),
        array('displayorder' => 14, 'title' => '启用群组帖子', 'description' => '允许群组帖子触发自动回帖。', 'variable' => 'opengroup', 'type' => 'select', 'value' => '0', 'extra' => "1=是\n0=否"),
        array('displayorder' => 15, 'title' => '启用门户文章', 'description' => '允许门户文章页触发自动回复。', 'variable' => 'openarticle', 'type' => 'select', 'value' => '0', 'extra' => "1=是\n0=否"),
        ...
        array('displayorder' => 18, 'title' => 'AI 回复进入审核', 'description' => '开启后，非免审用户组触发的 AI 回复进入审核。', 'variable' => 'openinvisible', 'type' => 'select', 'value' => '0', 'extra' => "1=是\n0=否"),
        ...
        array('displayorder' => 20, 'title' => '追加回复尾巴', 'description' => '在生成回复后追加固定文本。', 'variable' => 'openfrom', 'type' => 'select', 'value' => '0', 'extra' => "1=是\n0=否"),
        array('displayorder' => 21, 'title' => '回复尾巴内容', 'description' => '开启追加回复尾巴后使用的固定文本。', 'variable' => 'from', 'type' => 'text', 'value' => '', 'extra' => ''),
        array('displayorder' => 22, 'title' => '启用类型限制组件', 'description' => '可选扩展，需要 components/type.php。', 'variable' => 'openlimittype', 'type' => 'select', 'value' => '0', 'extra' => "1=是\n0=否"),
        array('displayorder' => 23, 'title' => '启用发帖时间限制', 'description' => '只回复指定时间之后发布的帖子。', 'variable' => 'opentime', 'type' => 'select', 'value' => '0', 'extra' => "1=是\n0=否"),
        array('displayorder' => 24, 'title' => '发帖时间限制', 'description' => '仅在启用时间限制后生效，请选择日期和时间。', 'variable' => 'limittime', 'type' => 'datetime', 'value' => '', 'extra' => ''),
        array('displayorder' => 25, 'title' => '启用延迟回复', 'description' => '距离帖子最后活动不足指定秒数时不回复。', 'variable' => 'opendelayreply', 'type' => 'select', 'value' => '0', 'extra' => "1=是\n0=否"),
        array('displayorder' => 26, 'title' => '延迟回复秒数', 'description' => '填写秒数或随机范围，例如：60~300。', 'variable' => 'delaytime', 'type' => 'text', 'value' => '0', 'extra' => ''),
        array('displayorder' => 27, 'title' => '启用首楼 VIP 组件', 'description' => '可选扩展，需要 components/firstvip.php。', 'variable' => 'openfirstvip', 'type' => 'select', 'value' => '0', 'extra' => "1=是\n0=否"),
        array('displayorder' => 28, 'title' => '启用角色组件', 'description' => '可选扩展，需要 components/role.php。', 'variable' => 'openrole', 'type' => 'select', 'value' => '0', 'extra' => "1=是\n0=否"),
        array('displayorder' => 29, 'title' => '回复风格限制', 'description' => '给提示词追加内置风格要求。', 'variable' => 'openlimit', 'type' => 'select', 'value' => '0', 'extra' => "0=不限制\n1=简短\n2=自然且不重复原文\n3=友好的论坛回复风格"),
        array('displayorder' => 30, 'title' => '启用限制触发组件', 'description' => '可选扩展，需要 components/limittriggering.php。', 'variable' => 'openlimittriggering', 'type' => 'select', 'value' => '0', 'extra' => "1=是\n0=否"),
        ...
        array('displayorder' => 33, 'title' => '启用阿里云组件', 'description' => '可选扩展，需要 components/aliyun.php。', 'variable' => 'openaliyunds', 'type' => 'select', 'value' => '0', 'extra' => "1=是\n0=否"),
    );
